...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="#"><img src="{{url('public/img/logo.png')}}" alt="logo"></a></div>
      ...
      <div class="hero_section">
        <div class="row">
          ...
          <div class="col-lg-7 col-sm-5">
			<img src="{{url('public/img/main_device_image.png')}}" class="zoomIn wow animated" alt="" />
		  </div>
        </div>
      </div>
    </div>
...
<div class="client_logos"><!--client_logos-->
  <div class="container">
    <ul class="fadeInRight animated wow">
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo1.png')}}" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo2.png')}}" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo3.png')}}" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="{{url('public/img/client_logo5.png')}}" alt=""></a></li>
    </ul>
  </div>
</div>
</section>
